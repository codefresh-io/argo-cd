...
const (
	...
	//EnvEnableUpdateRevisionForPaths enables update revision for paths during app reconciliation
	EnvEnableUpdateRevisionForPaths = "ARGOCD_ENABLE_UPDATE_REVISION_FOR_PATHS"
